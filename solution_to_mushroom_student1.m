...
for hold_out_ratio = 0.7:-0.1:0.3   %hold out ratio from 70% down to 30%. That is hold out 70% of data for validation to 30% of data
    ...
    cm_2 = confusionmat(table2cell(trueLabels_test),predictLabels_test)
    ...
    cm_2 = confusionmat(table2cell(trueLabels_training),predictLabels_training)% confusion matrix
    TP = cm_2(1,1)
    FP = cm_2(1,2)
    FN = cm_2(2,1)
    TN = cm_2(2,2)
